    ...
    return room && (
        <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
                ...
                <div className='flex flex-col flex-wrap md:flex-row items-start md:items-center gap-4 md:gap-10 text-gray-500'>
                    ...
                    <div className='flex flex-col'>
                        ...
                        <input type="date" id="checkInDate" placeholder='Check-In'
                            className='w-full rounded border border-gry-300 px-3 py-2 mt-1.5 outline-none' required />
                    </div>
            ...
            <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500 '>
                <p>Guests will be allocated on the ground floor according to availability.You get a comfortable Two Bedroom Apartment has a true City feeling.The price quoted is for Two guests, at the guest slot please mark the number of guests to get the exact price for groups.The Guest will be allocated ground floor according to availability.You get the comfortable Two bedroom Apartment that has a true City feeling.</p>
            </div>
