...
const MyBookings = () => {
  ...
  return (
    <div className='py-28 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32'>
        <Title title="My Bookings" subTitle="Easily manage your past,current and upcomming hotel reservations in one place.Plan your trip seemlessly 
        with just a few click." align="left" />
